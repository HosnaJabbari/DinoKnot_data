    ...
    for filename in os.listdir(input_directory):
        if filename.endswith(".bpseq"):
            ...
            if df['pair_id'].isin([pair_id]).any():
                ...
                output_filename = f"{pair_id}_filtered_snorna_ref_output.bpseq"
                with open(os.path.join(output_directory, output_filename), 'w') as outfile:
                    outfile.writelines(filtered_rows)

# Example usage:
input_dir = '/home/tara/paper_revisions/RNAcofold/reference_structures/RNAcofold_snorna_reference_output'
output_dir = '/home/tara/paper_revisions/RNAcofold/reference_structures/RNAcofold_snorna_reference_output/filtered'
csv_file = 'snorna.csv'
