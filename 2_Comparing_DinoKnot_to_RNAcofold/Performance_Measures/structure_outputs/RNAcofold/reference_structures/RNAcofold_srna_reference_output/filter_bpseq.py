                    ...
                    for line in file:
                        ...
                        if len(parts) == 3:
                            ...
                            if (index >= srna_site_start and index <= srna_site_end) or \
                               (index >= (mrna_site_start + srna_length ) and index <= (mrna_site_end + srna_length )):
...
# Example usage:
input_dir = '/home/tara/paper_revisions/RNAcofold/reference_structures/RNAcofold_srna_reference_output'
output_dir = '/home/tara/paper_revisions/RNAcofold/reference_structures/RNAcofold_srna_reference_output/filtered'
csv_file = 'srna.csv'
